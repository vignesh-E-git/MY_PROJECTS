...
tf.keras.layers.GroupNormalization = tfa.layers.GroupNormalization
...
# instantiating sequencers(preprocessing)
sequencers = {}
for split in splits:
...
# creating FOLDER TO STORE training results
